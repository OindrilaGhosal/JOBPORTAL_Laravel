...
@section('content')
    <div class="container">
        <div class="row justify-content-left">
            <div class="col-xl-3">
                ...
                <form action="{{route('profile.avatar')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card bg-transparent">
                        <div class="card-header bg-info">Update Your Photo</div>
                        <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="card bg-transparent">
                    <div class="card-header bg-info">Update Your Information</div>
                        <div class="card-body">
            ...
            <div class="row justify-content-center" >
                <div class="col-md-6" >
                    <div class="card bg-transparent">
                        <div class="card-header bg-info">User Details</div>
                        <div class="card-body">
                            ...
                            @if(!empty (Auth::user()->profile->resume))
                                ...
                                @else
                                    <p>Please Upload Your Resume Letter</p>
                                @endif
                        </div>
                    </div>
                    ...
                    @csrf
                        <div class="card bg-transparent">
                        <div class="card-header bg-info">Update Cover Letter</div>
                            <div class="card-body">
                    ...
                    <form action="{{route('profile.resume')}}" method="post" enctype="multipart/form-data">
                        @csrf
                    <div class="card bg-transparent">
                        <div class="card-header bg-info">Update Resume</div>
                            <div class="card-body">
